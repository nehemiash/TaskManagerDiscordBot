...
public class BotsfordiscordCOM {


    private static final String baseURL = "https://botsfordiscord.com/api";
    private static final String apiKey = Main.dotenv.get("BOTSFORDISCORD.COM_API_KEY") != null ? Main.dotenv.get("BOTSFORDISCORD.COM_API_KEY") : System.getenv("BOTSFORDISCORD.COM_API_KEY");
