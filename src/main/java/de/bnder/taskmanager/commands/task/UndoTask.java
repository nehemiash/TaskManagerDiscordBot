    ...
    public static void undoTask(Member member, TextChannel textChannel, String[] args, SlashCommandEvent slashCommandEvent) {
        ...
        if (statusCode == 200) {
            ...
            if (taskStatus == TaskStatus.TODO) {
                ...
                MessageSender.send(embedTitle, Localizations.getString("task_request_unknown_error", langCode) + " " + task.getResponseMessage(), textChannel, Color.red, langCode, slashCommandEvent);
            }
