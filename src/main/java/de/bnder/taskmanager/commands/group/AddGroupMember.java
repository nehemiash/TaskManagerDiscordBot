...
public class AddGroupMember {
    ...
    public static void addGroupMember(Member member, TextChannel textChannel, String groupName, List<Member> mentionedMembers, SlashCommandEvent slashCommandEvent) throws IOException {
